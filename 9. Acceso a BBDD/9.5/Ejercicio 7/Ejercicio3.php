...
//Obtiene los valores de los productos de la BBDD tienda
        ...
        <tbody>
            ...
            for ($i = 0; $i < count($_SESSION['productos']); $i++) {
                echo '<tr>
                    ...
                    <td><a href="./Ejercicio3-Catalogo.php?selector=' . $i . '"><img src="data:image/jpg;charset=uft8;base64,' . base64_encode($_SESSION['productos'][$i][2]) . '"></a></td>
